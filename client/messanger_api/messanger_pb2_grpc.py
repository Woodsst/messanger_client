...
class MessangerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RemoveRoom = channel.unary_unary(
                ...
                request_serializer=messanger__pb2.RemoveRoomReqeust.SerializeToString,
                response_deserializer=messanger__pb2.Response.FromString,
                )
        self.MessagesUpdate = channel.unary_unary(
                '/Messanger/MessagesUpdate',
                request_serializer=messanger__pb2.MessagesUpdateRequest.SerializeToString,
                response_deserializer=messanger__pb2.UpdateData.FromString,
                )
...
def add_MessangerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RemoveRoom': grpc.unary_unary_rpc_method_handler(
                    servicer.RemoveRoom,
                    request_deserializer=messanger__pb2.RemoveRoomReqeust.FromString,
                    response_serializer=messanger__pb2.Response.SerializeToString,
            ),
            'MessagesUpdate': grpc.unary_unary_rpc_method_handler(
                    servicer.MessagesUpdate,
                    request_deserializer=messanger__pb2.MessagesUpdateRequest.FromString,
                    response_serializer=messanger__pb2.UpdateData.SerializeToString,
            ),
    }
...
class Messanger(object):
    ...
    def RemoveRoom(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Messanger/RemoveRoom',
            messanger__pb2.RemoveRoomReqeust.SerializeToString,
            messanger__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def MessagesUpdate(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Messanger/MessagesUpdate',
            messanger__pb2.MessagesUpdateRequest.SerializeToString,
            messanger__pb2.UpdateData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
